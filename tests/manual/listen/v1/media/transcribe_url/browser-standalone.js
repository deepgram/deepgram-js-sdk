...
/**
 * Standalone Playwright browser test with on-the-fly webpack bundling
 *
 * This script:
 ...
 * 4. Tests the SDK in a headless browser
 * 5. Cleans up
 */
...
function createServer(testDir, port) {
    const server = http.createServer((req, res) => {
        let filePath = path.join(testDir, req.url === "/" ? "test.html" : req.url);
