...
describe("Listen v1 REST transcription", () => {
    ...
    describe("URL-based transcription", () => {
        it("should transcribe audio from URL", async () => {
            ...
            server.mockEndpoint().post("/v1/listen").respondWith().statusCode(200).jsonBody(mockResponse).build();
            ...
            expect(result.results?.channels?.[0]?.alternatives?.[0]?.transcript).toBe(
        ...
        it("should handle transcription with multiple options", async () => {
            const mockResponse = {
                ...
                results: {
                            ...
                            alternatives: [
                                {
                                    ...
                                    confidence: 0.95,
                                    paragraphs: {
                                        paragraphs: [{ sentences: [{ text: "Test transcript with features." }] }],
                                    },
                                },
                            ],
                        },
                    ...
                    topics: {
                        segments: [{ topics: [{ topic: "testing", confidence: 0.9 }] }],
                    },
                    sentiments: {
                        segments: [{ sentiment: "neutral", confidence: 0.85 }],
                    },
                },
            };
            ...
            const mockResponse = {
                ...
                results: {
                    channels: [
                        {
                            detected_language: "es",
                            alternatives: [{ transcript: "Hola, ¿cómo estás?", confidence: 0.92 }],
                        },
                    ],
                },
            };
    ...
    describe("Callback support", () => {
        it("should accept callback URL", async () => {
            ...
            server.mockEndpoint().post("/v1/listen").respondWith().statusCode(202).jsonBody(mockResponse).build();
    ...
    describe("Error handling", () => {
        it("should handle 400 bad request", async () => {
            ...
            server.mockEndpoint().post("/v1/listen").respondWith().statusCode(400).jsonBody(errorResponse).build();
        ...
        it("should handle 401 unauthorized", async () => {
            ...
            server.mockEndpoint().post("/v1/listen").respondWith().statusCode(401).jsonBody(errorResponse).build();
        ...
        it("should handle 429 rate limit", async () => {
            ...
            server.mockEndpoint().post("/v1/listen").respondWith().statusCode(429).jsonBody(errorResponse).build();
    ...
    describe("Multiple keyterms", () => {
        it("should handle multiple keywords/keyterms", async () => {
            const mockResponse = {
                ...
                results: {
                    channels: [{ alternatives: [{ transcript: "Deepgram is amazing", confidence: 0.95 }] }],
                },
            };
