...
async function getAllBalances() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.billing.balances.list(projectId);
...
async function getSpecificBalance(balanceId) {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.billing.balances.get(projectId, balanceId);
...
async function getBillingBreakdownByLineItem() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.billing.breakdown.list(projectId, {
...
async function getPurchaseHistory() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.billing.purchases.list(projectId, {
...
async function getBillingFields() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.billing.fields.list(projectId, {
            // Optional: Filter by date range
            // start: "2024-01-01",
            // end: "2024-12-31",
        });
