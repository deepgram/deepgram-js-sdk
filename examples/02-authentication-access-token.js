...
const deepgramClient = createClient({ accessToken: process.env.DEEPGRAM_ACCESS_TOKEN });
...
async function example() {
  ...
  const { result: tokenDetails, error: tokenError } = await tempClient.manage.getTokenDetails();
