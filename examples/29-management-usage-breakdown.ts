...
async function getBasicUsage() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.usage.get(projectId, {
...
async function getUsageBreakdownByTag() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.usage.breakdown.get(projectId, {
...
async function getUsageByEndpoint() {
    ...
    try {
        ...
        const listenSync = await deepgramClient.manage.v1.projects.usage.breakdown.get(projectId, {
            endpoint: "listen",
            method: "sync",
        });
        ...
        const speak = await deepgramClient.manage.v1.projects.usage.breakdown.get(projectId, {
            endpoint: "speak",
        });
...
async function getUsageFields() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.usage.fields.list(projectId, {
            // Optional: Filter by date range
            // start: "2024-01-01",
            // end: "2024-12-31",
        });
