...
async function listProjectModels() {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.models.list(projectId, {
...
async function getModelDetails(modelId) {
    ...
    try {
        const data = await deepgramClient.manage.v1.projects.models.get(projectId, modelId);
...
async function compareGlobalAndProjectModels() {
    ...
    try {
        ...
        const projectModels = await deepgramClient.manage.v1.projects.models.list(projectId, {
            include_outdated: false,
        });
...
async function findModelByName(modelName) {
    ...
    try {
        ...
        const matchingModels = data.stt?.filter((m) => m.name?.toLowerCase().includes(modelName.toLowerCase())) || [];
        ...
        if (matchingModels.length > 0) {
            ...
            for (const model of matchingModels) {
                ...
                try {
                    const details = await deepgramClient.manage.v1.projects.models.get(projectId, model.uuid);
...
async function trackModelVersions() {
    ...
    try {
        const allModels = await deepgramClient.manage.v1.projects.models.list(projectId, {
            include_outdated: true,
        });

        const latestModels = await deepgramClient.manage.v1.projects.models.list(projectId, {
            include_outdated: false,
        });
