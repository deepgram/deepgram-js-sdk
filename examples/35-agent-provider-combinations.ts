    ...
    const configuration = {
        ...
        agent: {
            ...
            think: {
                ...
                prompt: "You are a premium customer service agent. Be professional, empathetic, and thorough. Always prioritize customer satisfaction.",
            },
            speak: {
                provider: {
                    type: "eleven_labs",
    ...
    const configuration = {
        ...
        agent: {
            ...
            think: {
                ...
                prompt: "You are a quick and helpful assistant. Provide concise, accurate responses.",
            },
            speak: {
                provider: {
                    type: "cartesia",
    ...
    const configuration = {
        ...
        agent: {
            ...
            think: {
                ...
                prompt: "You are a helpful and professional AI assistant. Provide accurate and friendly responses.",
            },
            speak: {
                provider: {
                    type: "deepgram",
...
function enterpriseAws(): void {
    ...
    console.log("  • Quality: ★★★★☆ (4/5)");
    console.log("  • Cost: $$ (Moderate)");
    console.log("  • Best for: Enterprise AWS deployments, compliance requirements");
    console.log("\nAdditional Benefits:");
...
function main(): void {
    ...
    console.log("and optimize based on real-world usage patterns!\n");
}
