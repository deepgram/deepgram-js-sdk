...
async function transcribeWithReadStream() {
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(createReadStream("./examples/spacewalk.wav"), {
            model: "nova-3",
        });
...
async function transcribeWithBuffer() {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(buffer, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
...
async function transcribeWithReadableStream() {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(stream, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
...
async function transcribeWithBlob() {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(blob, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
...
async function transcribeWithFile(fileInput) {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(file, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
...
async function transcribeWithArrayBuffer() {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(arrayBuffer, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
...
async function transcribeWithUint8Array() {
    ...
    try {
        const data = await deepgramClient.listen.v1.media.transcribeFile(uint8Array, {
            model: "nova-3",
        });
        console.log("Transcription:", data);
    } catch (error) {
