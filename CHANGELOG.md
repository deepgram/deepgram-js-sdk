...
* **release:** build the commit tagged by Release Please and publish through npm Trusted Publishing (GitHub OIDC), preventing source/artifact drift and stopping use of the long-lived npm publish token. ([#545](https://github.com/deepgram/deepgram-js-sdk/issues/545))
