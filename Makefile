...
help:
	...
	@printf "  \033[1;32mmake examples\033[0m          - Run all example scripts (1-39) sequentially\n"
	...
	@printf "  \033[36m39\033[0m - Transcription Live Reconnect\n"
...
examples:
	...
	run_example 39 "examples/39-transcription-live-reconnect.ts" "Transcription Live Reconnect"; \
	\
	printf "\n\033[1;36m=========================================\033[0m\n"; \
...
example-39:
	pnpm exec tsx examples/39-transcription-live-reconnect.ts
