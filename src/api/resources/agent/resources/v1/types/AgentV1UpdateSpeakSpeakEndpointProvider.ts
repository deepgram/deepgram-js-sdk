...
export type AgentV1UpdateSpeakSpeakEndpointProvider =
    | Deepgram.agent.AgentV1UpdateSpeakSpeakEndpointProvider.Deepgram
    | Deepgram.agent.AgentV1UpdateSpeakSpeakEndpointProvider.ElevenLabs
    | Deepgram.agent.AgentV1UpdateSpeakSpeakEndpointProvider.Cartesia
    | Deepgram.agent.AgentV1UpdateSpeakSpeakEndpointProvider.OpenAi
    | Deepgram.agent.AgentV1UpdateSpeakSpeakEndpointProvider.AwsPolly;

export namespace AgentV1UpdateSpeakSpeakEndpointProvider {
    export interface Deepgram {
        type: "deepgram";
        /** The REST API version for the Deepgram text-to-speech API */
        version?: "v1" | undefined;
        /** Deepgram TTS model */
        model: AgentV1UpdateSpeakSpeakEndpointProviderDeepgram.Model;
    }

    export namespace AgentV1UpdateSpeakSpeakEndpointProviderDeepgram {
        /** Deepgram TTS model */
        export const Model = {
    ...
    export interface ElevenLabs {
        ...
        model_id: AgentV1UpdateSpeakSpeakEndpointProviderElevenLabs.ModelId;
    ...
    export interface Cartesia {
        ...
        /** Cartesia model ID */
        model_id: AgentV1UpdateSpeakSpeakEndpointProviderCartesia.ModelId;
        voice: AgentV1UpdateSpeakSpeakEndpointProviderCartesia.Voice;
    ...
    export interface OpenAi {
        ...
        version?: "v1" | undefined;
        /** OpenAI TTS model */
        model: AgentV1UpdateSpeakSpeakEndpointProviderOpenAi.Model;
        /** OpenAI voice */
        voice: AgentV1UpdateSpeakSpeakEndpointProviderOpenAi.Voice;
    }

    export namespace AgentV1UpdateSpeakSpeakEndpointProviderOpenAi {
        /** OpenAI TTS model */
        export const Model = {
            Tts1: "tts-1",
            Tts1Hd: "tts-1-hd",
    ...
    export interface AwsPolly {
        ...
        voice: AgentV1UpdateSpeakSpeakEndpointProviderAwsPolly.Voice;
        /** Language code to use, e.g. 'en-US'. Corresponds to the `language_code` parameter in the AWS Polly API */
        language: string;
        /** Use the `language` field instead. */
        language_code?: string | undefined;
        engine: AgentV1UpdateSpeakSpeakEndpointProviderAwsPolly.Engine;
        credentials: AgentV1UpdateSpeakSpeakEndpointProviderAwsPolly.Credentials;
    }

    export namespace AgentV1UpdateSpeakSpeakEndpointProviderAwsPolly {
        /** AWS Polly voice name */
        export const Voice = {
            Matthew: "Matthew",
            Joanna: "Joanna",
