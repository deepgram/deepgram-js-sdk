...
export type AgentV1UpdateSpeakSpeakOneItemProvider =
    | Deepgram.agent.AgentV1UpdateSpeakSpeakOneItemProvider.Deepgram
    | Deepgram.agent.AgentV1UpdateSpeakSpeakOneItemProvider.ElevenLabs
    | Deepgram.agent.AgentV1UpdateSpeakSpeakOneItemProvider.Cartesia
    | Deepgram.agent.AgentV1UpdateSpeakSpeakOneItemProvider.OpenAi
    | Deepgram.agent.AgentV1UpdateSpeakSpeakOneItemProvider.AwsPolly;

export namespace AgentV1UpdateSpeakSpeakOneItemProvider {
    export interface Deepgram {
        type: "deepgram";
        /** The REST API version for the Deepgram text-to-speech API */
        version?: "v1" | undefined;
        /** Deepgram TTS model */
        model: AgentV1UpdateSpeakSpeakOneItemProviderDeepgram.Model;
    }

    export namespace AgentV1UpdateSpeakSpeakOneItemProviderDeepgram {
        /** Deepgram TTS model */
        export const Model = {
    ...
    export interface ElevenLabs {
        ...
        model_id: AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs.ModelId;
    ...
    export namespace AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs {
        /** Eleven Labs model ID */
    ...
    export interface Cartesia {
        ...
        /** Cartesia model ID */
        model_id: AgentV1UpdateSpeakSpeakOneItemProviderCartesia.ModelId;
        voice: AgentV1UpdateSpeakSpeakOneItemProviderCartesia.Voice;
        /** Cartesia language code */
        language?: string | undefined;
    }

    export namespace AgentV1UpdateSpeakSpeakOneItemProviderCartesia {
        /** Cartesia model ID */
        export const ModelId = {
            Sonic2: "sonic-2",
    ...
    export interface OpenAi {
        ...
        version?: "v1" | undefined;
        /** OpenAI TTS model */
        model: AgentV1UpdateSpeakSpeakOneItemProviderOpenAi.Model;
        /** OpenAI voice */
        voice: AgentV1UpdateSpeakSpeakOneItemProviderOpenAi.Voice;
    }

    export namespace AgentV1UpdateSpeakSpeakOneItemProviderOpenAi {
        /** OpenAI TTS model */
        export const Model = {
            Tts1: "tts-1",
            Tts1Hd: "tts-1-hd",
    ...
    export interface AwsPolly {
        ...
        voice: AgentV1UpdateSpeakSpeakOneItemProviderAwsPolly.Voice;
        /** Language code to use, e.g. 'en-US'. Corresponds to the `language_code` parameter in the AWS Polly API */
        language: string;
        /** Use the `language` field instead. */
        language_code?: string | undefined;
        engine: AgentV1UpdateSpeakSpeakOneItemProviderAwsPolly.Engine;
        credentials: AgentV1UpdateSpeakSpeakOneItemProviderAwsPolly.Credentials;
    }

    export namespace AgentV1UpdateSpeakSpeakOneItemProviderAwsPolly {
        /** AWS Polly voice name */
        export const Voice = {
            Matthew: "Matthew",
            Joanna: "Joanna",
