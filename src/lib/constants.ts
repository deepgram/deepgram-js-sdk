import { convertProtocolToWs, getAgentMarker, isBrowser, isBun, isNode } from "./helpers";
...
export const USER_AGENT = `@deepgram/sdk/${version}/${getAgentMarker()}`;

export const WS_USER_AGENT = USER_AGENT.replace(/[^!#$%&'*+\-.^_`|~0-9a-zA-Z]/g, "-");
