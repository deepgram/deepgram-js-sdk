...
- [Transcription (Synchronous)](#transcription-synchronous)
  - [Remote Files](#synchronous-remote-files)
  - [Local Files](#synchronous-local-files)
- [Transcription (Asynchronous / Callbacks)](#transcription-asynchronous--callbacks)
  - [Remote Files](#asynchronous-remote-files)
  - [Local Files](#asynchronous-local-files)
