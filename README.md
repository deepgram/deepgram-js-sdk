...
The SDK has been rebuilt using [Fern](https://buildwithfern.com) for auto-generation, providing better TypeScript support and a more structured API. **See [MIGRATION_GUIDE_V4_TO_V5.md](./MIGRATION_GUIDE_V4_TO_V5.md) for a comprehensive migration guide.**
